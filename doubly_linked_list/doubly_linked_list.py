...
class DoublyLinkedList:
    ...
    def remove_from_head(self):
        self.head.delete()
        return_variable = self.head.value if self.head is not None else None
        self.length -= 1
    ...
    def remove_from_tail(self):
        self.tail.delete()
        return_variable = self.tail.value if self.tail is not None else None
        self.length -= 1
    ...
    def move_to_end(self, node):
        # what if node is already the tail
    ...
    # other solution thats thought of
    """
    def move_to_front(self, node):
        self.head.prev = node
    ...
    def move_to_end(self, node):
        ...
        self.tail = self.tail.next
    """
    # end of other solution thats thought of
